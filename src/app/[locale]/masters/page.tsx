          ...
          <div className="container mx-auto px-4">
            {loading ? (
                        ...
                        {master.achievements && master.achievements.length > 0 && (
                          <div className="mb-4">
                            <div className="flex items-center gap-2 mb-2">
                              ...
                              <span className="text-sm text-neutral-400">{t('achievements')}</span>
                            </div>
              ...
              <div className="text-center py-20">
                ...
                <h3 className="text-xl text-neutral-800 mb-2">{t('infoSoon')}</h3>
                <p className="text-neutral-500">{t('preparingStories')}</p>
              </div>
            )}
          </div>
        </section>
